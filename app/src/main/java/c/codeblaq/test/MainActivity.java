...
import c.codeblaq.test.Adapters.LocationRecyclerAdapter;
...
//        intitializeContentDisplay();
    }

    private void intitializeContentDisplay() {
//
//        //Create Recycler View variable
//        final RecyclerView recyclerLocations  = findViewById (R.id.list_attractions_horizontal);
//
...
//        mLocationRecyclerAdapter = new LocationRecyclerAdapter(this, locations);
